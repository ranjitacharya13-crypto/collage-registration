...
export const ALLOWED_EVENTS = ['Flush the Brain', 'Treasure Hunt', 'Bug Hunt', 'Murder Mystery', 'Debate'];
export const TEAM_EVENTS = new Set(['Flush the Brain', 'Treasure Hunt', 'Murder Mystery', 'Debate']);
export const EVENT_CHOICES = { Debate: ['Android', 'iOS'] };
// Year 3 students are not eligible for these events.
export const YEAR_THREE_BLOCKED = new Set(['Flush the Brain', 'Treasure Hunt', 'Murder Mystery']);
// Year 3 students may take part in these events, but only fifteen places each
// (the original five plus ten extra slots added for Bug Hunt and Debate).
